<template>
  <Card>
    <div class="w-full flex flex-col">
      <DTTopBar title="Top 10 Lead Setters">
        <FormKit
          type="dropdown"
          name="setter_top_10_period"
...
const top10QueryRef = computed(() => {
  return getTop10ReportQuery(activePeriod.value, activeOrder.value, activeUnit.value, 'leadSetters')
})
